# Requirements: adman v1.0

**Defined:** 2026-07-10
**Shipped:** 2026-07-23
**Core Value:** Any admin on the team can perform common AD user/computer tasks correctly and safely — every destructive action is previewed (`-WhatIf`/dry-run), confirmed, scoped to a managed OU, blocked from protected accounts, and written to an audit log.

> 58/58 v1 requirements mapped, implemented, and verified. 0 unmapped, 0 duplicates.
...
- [x] **RPT-04**: Remote operations handle the double-hop by design (avoid second hop preferred; RBCD/JEA over CredSSP; never for "sensitive, cannot be delegated" accounts)
...
---
*Archived from .planning/REQUIREMENTS.md on 2026-07-23*
