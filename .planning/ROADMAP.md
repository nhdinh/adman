...
- [x] 04-04-PLAN.md — Menu integration + manifest exports + phase exit gate: wire bulk/onboarding/offboarding/restore into Get-AdmanMenuDefinition, update adman.psd1 FunctionsToExport, run recursive PSScriptAnalyzer and full unit suite (FLOW-01..04, BULK-01..04).
...
- [x] 05-01a2-PLAN.md — Comment-based help for AD user/computer lifecycle functions (DOC-03).
- [x] 05-01a3-PLAN.md — Comment-based help for local account, group, bulk, and workflow functions (DOC-03).
...
| 5. Hardening & Portability | 5/6 | In Progress|  |
