...
function New-ADUser { [CmdletBinding(SupportsShouldProcess)] param($Name, $SamAccountName, $UserPrincipalName, $Path, $AccountPassword, $Enabled, $Server) if ($PSCmdlet.ShouldProcess($Name, 'New-ADUser (mock)')) { New-AdmanMockObject } }
