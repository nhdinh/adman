...
@{
    ...
    FunctionsToExport = @('Initialize-Adman', 'Start-Adman', 'Get-AdmanConfig', 'Set-AdmanConfig', 'Export-AdmanConfig', 'Import-AdmanConfig', 'Test-AdmanCapability', 'Find-AdmanUser', 'Find-AdmanComputer', 'Get-AdmanStaleReport', 'Get-AdmanAccountStateReport', 'Get-AdmanRecoveryPostureReport', 'Format-AdmanReport', 'Export-AdmanReportCsv', 'Export-AdmanReportHtml', 'Get-AdmanInventoryReport', 'New-AdmanUser', 'Disable-AdmanUser', 'Enable-AdmanUser', 'Set-AdmanUserPassword', 'Unlock-AdmanUser', 'Move-AdmanUser', 'Disable-AdmanComputer', 'Enable-AdmanComputer', 'Move-AdmanComputer', 'Reset-AdmanComputerAccount')
